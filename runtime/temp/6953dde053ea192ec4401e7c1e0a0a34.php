<?php /*a:1:{s:77:"E:\phpStudy\PHPTutorial\WWW\ljh\application\backstage\view\auth_group\lst.htm";i:1551685505;}*/ ?>
<!DOCTYPE html>
  ...
  <table class="layui-table layui-form">
    ...
    <tbody class="x-cate">
      ...
      <tr fid='0' >
        ...
        <td>
          <span <?php if($vo['status'] == 1): ?> class="layui-btn layui-btn-normal" <?php else: ?> class="layui-btn layui-btn-danger" <?php endif; ?> id="<?php echo htmlentities($vo['id']); ?>" onclick="changestatus(this)"><?php if($vo['status'] == 1): ?>启用<?php else: ?>禁用<?php endif; ?></span>
        </td>
        <td class="td-manage">
          <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','edit.html?id=<?php echo htmlentities($vo['id']); ?>')" ><i class="layui-icon">&#xe642;</i>编辑</button>
          <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="x_admin_show('权限','key.html?id=<?php echo htmlentities($vo['id']); ?>')" ><i class="layui-icon">&#xe673;</i>权限</button>
